...
**`app/agents/tools.py`** — Three `@tool`-decorated functions:
- `search_symptoms` — BM25 search against Elasticsearch index `edu-collection`
- `get_medication_info` — calls the Korean MFDS drug info API (e약은요)
